...
export default function HeaderControls() {
  ...
  // Function to display text based on selected range
  const getRangeText = () => {
    switch (selectedRange) {
      case "last7Days":
        return "18 Nov - 24 Nov";
      case "last30Days":
        return "26 Oct - 24 Nov";
      case "thisMonth":
        return "1 Nov - 24 Nov";
      default:
        return "Select Date";
    ...
    <div className="mt-20 px-6 md:px-12">
      <div className="flex flex-col md:flex-row items-center justify-between bg-white p-4 rounded-md space-y-4 md:space-y-0">
        ...
        <div className="flex items-center space-x-4 flex-shrink-0">
          ...
          <button className="border border-gray-300 rounded-lg px-3 py-2 bg-white hover:bg-gray-50 whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-blue-500">
            {getRangeText()}
          </button>
        </div>
